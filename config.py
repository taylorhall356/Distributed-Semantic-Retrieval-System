...
DOCUMENT_PARSING_QUEUE = os.getenv("DOCUMENT_PARSING_QUEUE", "document_parsing")
DOCUMENT_EMBEDDING_QUEUE = os.getenv("DOCUMENT_EMBEDDING_QUEUE", "document_embedding")
